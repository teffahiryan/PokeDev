 ...
 */
final class Version20210913171420 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE catch_pokemon (id INT AUTO_INCREMENT NOT NULL, user_id_id INT NOT NULL, equipe_id_id INT DEFAULT NULL, pokemon_id_id INT NOT NULL, INDEX IDX_EF9CC32C9D86650F (user_id_id), INDEX IDX_EF9CC32C254808DD (equipe_id_id), INDEX IDX_EF9CC32C90AD2703 (pokemon_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, equipe_id_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, pseudo VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D649254808DD (equipe_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE bot ADD CONSTRAINT FK_11F0411254808DD FOREIGN KEY (equipe_id_id) REFERENCES equipe (id)');
        $this->addSql('ALTER TABLE catch_pokemon ADD CONSTRAINT FK_EF9CC32C9D86650F FOREIGN KEY (user_id_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE catch_pokemon ADD CONSTRAINT FK_EF9CC32C254808DD FOREIGN KEY (equipe_id_id) REFERENCES equipe (id)');
        $this->addSql('ALTER TABLE catch_pokemon ADD CONSTRAINT FK_EF9CC32C90AD2703 FOREIGN KEY (pokemon_id_id) REFERENCES pokemon (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE catch_pokemon DROP FOREIGN KEY FK_EF9CC32C254808DD');
        $this->addSql('ALTER TABLE user DROP FOREIGN KEY FK_8D93D649254808DD');
        $this->addSql('ALTER TABLE catch_pokemon DROP FOREIGN KEY FK_EF9CC32C90AD2703');
        ...
        $this->addSql('ALTER TABLE catch_pokemon DROP FOREIGN KEY FK_EF9CC32C9D86650F');
        $this->addSql('ALTER TABLE reset_password_request DROP FOREIGN KEY FK_7CE748AA76ED395');
        $this->addSql('DROP TABLE attack');
        $this->addSql('DROP TABLE bot');
        $this->addSql('DROP TABLE catch_pokemon');
